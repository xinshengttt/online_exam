<template>
  <my-el-top-bottom title="题目创建">
    <template #main>
      <el-form ref="ruleFormRef" :model="form" :rules="rules">
        <el-form-item prop="typeId" label="题目类型">
          <el-select
            v-model="form.typeId"
            placeholder="请选择"
            @change="cleanValue"
        ...
        <el-form-item prop="question" label="题目内容">
          <el-input rows="5" type="textarea" v-model="form.question"></el-input>
        </el-form-item>
        <el-form-item label="是否有标准答案" prop="isStandarAnswer">
          <el-radio-group v-model="form.isStandarAnswer">
        ...
        <el-form-item prop="answer" label="答案">
          ...
          <el-select
            v-show="[2, 3].includes(form.typeId)"
            v-model="form.answer"
        ...
        <el-form-item prop="difficultyId" label="难度">
          <el-rate :max="3" v-model="form.difficultyId" />
        </el-form-item>
        <el-form-item prop="status" label="是否与其他老师共享题目">
